...
class AgencyOperationsScreen extends StatelessWidget {
          ...
          return Column(
            children: [
              ...
              _OperationCard(
                ...
                description:
                    localizations.bookingManagement,
                color:
                    AppColors.secondary,
                onTap: () {
              ...
              _OperationCard(
                ...
                title: localizations
                    .travelerLuggage,
                description:
                    localizations.luggageManagement,
                color:
                    AppColors.warning,
                onTap: () {
              ...
              _OperationCard(
                ...
                title:
                    localizations.parcels,
                description:
                    localizations.parcelManagement,
                color:
  ...
  Widget _buildAuthorizationNotice(
    BuildContext context,
  ) {
    return GlassContainer(
      width: double.infinity,
