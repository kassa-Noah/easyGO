...
class AgencyConversationScreen
    extends StatefulWidget {
  final Map<String, dynamic> agency;

  const AgencyConversationScreen({
    super.key,
...
class _AgencyConversationScreenState
    extends State<AgencyConversationScreen> {
    ...
    _messages.addAll([
      {
        'sender': 'agency',
        'message':
            l10n.demoAgencyGreeting,
        'time': '09:10',
      },
      {
        'sender': 'client',
        'message':
            l10n.demoClientQuestion,
        'time': '09:12',
      },
      {
        'sender': 'agency',
        'message':
            l10n.demoAgencyResponse,
        'time': '09:14',
      },
    ]);
