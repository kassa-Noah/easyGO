...
class ParcelConfirmationScreen extends StatelessWidget {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(l10n.shipmentConfirmation),
        ),
        body: Container(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTrackingReference(context, l10n),
    ...
    return Column(
      children: [
        TweenAnimationBuilder<double>(
          tween: Tween<double>(begin: 0.70, end: 1),
        ...
        Text(
          l10n.parcelShipmentCreatedDescription,
          textAlign: TextAlign.center,
  ...
  Widget _buildTrackingReference(BuildContext context, AppLocalizations l10n) {
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.bodySmall?.copyWith(fontSize: 10, height: 1.4),
          ),
        ],
      ),
    );
