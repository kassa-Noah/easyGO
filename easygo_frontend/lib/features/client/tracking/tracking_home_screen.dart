...
class _TrackingHomeScreenState extends State<TrackingHomeScreen> {
  ...
  void _trackReference() {
    ...
    if (reference.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l10n.trackingReferenceRequired)));
  ...
  void _openTravelerLuggage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const TravelerLuggageScreen()),
    );
  }
  ...
  void _openIndependentParcel() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const ParcelHomeScreen()),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(automaticallyImplyLeading: false, title: Text(l10n.track)),
      body: Container(
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildReferenceTracking(context, l10n),
                      ...
                      _TrackingOptionCard(
                        ...
                        title: l10n.travelerLuggage,
                        subtitle: l10n.travelerLuggageDescription,
                        badge: l10n.linkedToBooking,
                        onTap: _openTravelerLuggage,
                      ),
                      ...
                      _TrackingOptionCard(
                        ...
                        title: l10n.independentParcel,
                        subtitle: l10n.independentParcelDescription,
                        badge: l10n.parcelService,
                        onTap: _openIndependentParcel,
                      ),

                      const SizedBox(height: 28),

                      _buildTrackingExplanation(context, l10n),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  l10n.trackYourItemsDescription,
                  style: const TextStyle(
                    fontSize: 12,
                    height: 1.4,
  ...
  Widget _buildReferenceTracking(BuildContext context, AppLocalizations l10n) {
    return GlassContainer(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.trackByReferenceDescription,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: l10n.trackingReferenceExample,
