...
class _ParcelServiceScreenState extends State<ParcelServiceScreen> {
  ...
  void _continueToPayment() {
    ...
    final Map<String, dynamic>? service = _selectedService;

    if (service == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.selectParcelTransportServiceError)),
      );
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ParcelPaymentScreen(
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, dynamic>? selectedService = _selectedService;

    return Scaffold(
      appBar: AppBar(title: Text(l10n.parcelServices)),
      body: Container(
        ...
        child: SafeArea(
          ...
          child: Column(
            children: [
                    ...
                    Center(
                      child: ConstrainedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            _buildParcelSummary(context, l10n),

                            const SizedBox(height: 26),

                            Text(
                              l10n.availableTransportServices,
                            ...
                            Text(
                              l10n.selectParcelAgencyDescription,
                              style: Theme.of(
                                context,
              ...
              _buildBottomSection(context, l10n, selectedService),
            ],
          ),
        ),
      ),
  ...
  Widget _buildParcelSummary(BuildContext context, AppLocalizations l10n) {
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: service == null ? null : _continueToPayment,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l10n.parcelDurationLabel(service['estimatedDuration']),
                    style: Theme.of(context).textTheme.bodySmall,
                  ),
                ),
