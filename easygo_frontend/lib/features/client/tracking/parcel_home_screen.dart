...
class ParcelHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.independentParcel)),
      body: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _ParcelActionCard(
                        ...
                        title: l10n.sendNewParcel,
                        description: l10n.sendNewParcelDescription,
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      _ParcelActionCard(
                        ...
                        description: l10n.myParcelsDescription,
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  l10n.interurbanParcelServiceDescription,
                  style: const TextStyle(
                    fontSize: 13,
                    height: 1.5,
    ...
    return GlassContainer(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              l10n.independentParcelInformation,
              style: Theme.of(
                context,
...
class _ParcelActionCard extends StatelessWidget {
  final IconData icon;
  final String title;
