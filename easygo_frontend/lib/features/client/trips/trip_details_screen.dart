...
class TripDetailsScreen extends StatelessWidget {
  ...
  void _openDigitalTicket(
    ...
    final Map<String, dynamic> agency = {
      'name': _stringValue('agency'),
    };

    final Map<String, dynamic> ticketTrip = {
      'departureTime':
          _stringValue('departureTime'),
      'arrivalTime':
          _stringValue('arrivalTime'),
      'class':
          _stringValue('travelClass'),
    };
  ...
  Widget _buildDoorToDoorJourney(
    BuildContext context,
    AppLocalizations l10n,
  ) {
    return _SectionCard(
      ...
      child: Column(
        children: [
          ...
          _JourneyStage(
            ...
            subtitle:
                '${_stringValue('agency')} • ${_stringValue('departureCity')}',
            status: l10n.scheduled,
          ),
          _JourneyStage(
            icon: Icons
            ...
            title:
                l10n.interurbanTrip,
            subtitle:
                '${_stringValue('departureCity')} → ${_stringValue('destinationCity')}',
            status: l10n
                .journeyStageStatusLabel(
              _stringValue('status'),
            ),
          ),
          _JourneyStage(
            ...
            title:
                l10n.arrivalAgency,
            subtitle:
                '${_stringValue('agency')} • ${_stringValue('destinationCity')}',
            status: l10n.scheduled,
          ),
          _JourneyStage(
            icon:
            ...
            subtitle: l10n
                .destinationTaxiAssignmentPending,
            status:
                l10n.pendingAssignment,
          ),
          _JourneyStage(
            ...
            title:
                l10n.finalDestination,
            subtitle:
                _stringValue(
              'finalDestination',
              fallback: l10n
                  .finalDestinationFallback,
            ),
            status: l10n.scheduled,
            last: true,
          ),
