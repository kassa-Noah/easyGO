...
class AppLocalizations {
  ...
  String get transportAgencies => isFrench
  ...
  String get clearSearch => isFrench
      ? 'Effacer la recherche'
      : 'Clear Search';

  String get clearSearchTooltip => isFrench
      ? 'Effacer la recherche'
      : 'Clear search';

  String get filterAll => isFrench ? 'Toutes' : 'All';

  String get filterTopRated => isFrench
      ? 'Mieux notées'
      : 'Top Rated';

  String get filterClosest => isFrench
      ? 'Plus proches'
      : 'Closest';

  String get filterPopular => isFrench
      ? 'Populaires'
      : 'Popular';

  String agenciesFound(int count) {
    return isFrench
        ? '$count trouvée${count > 1 ? 's' : ''}'
        : '$count found';
  }

  String get noAgenciesFound => isFrench
  ...
  String get agencyDetails => isFrench
      ? 'Détails de l’agence'
      : 'Agency Details';

  String get transportAgency => isFrench
      ? 'Agence de transport'
      : 'Transport Agency';
  ...
  String get messageAgency => isFrench
      ? 'Contacter l’agence'
      : 'Message Agency';

  String get aboutAgency => isFrench
  ...
  String get agencyInformation => isFrench
      ? 'Informations sur l’agence'
      : 'Agency Information';

  String get popularRoutes => isFrench
      ? 'Itinéraires populaires'
      : 'Popular Routes';

  String get customerReviews => isFrench
      ? 'Avis des clients'
      : 'Customer Reviews';
  ...
  String get openingHours => isFrench
      ? 'Heures d’ouverture'
      : 'Opening Hours';

  String get status => isFrench ? 'Statut' : 'Status';

  String get verifiedAgency => isFrench
      ? 'Agence vérifiée'
      : 'Verified Agency';

  String get agencyLocation => isFrench
      ? 'Localisation de l’agence'
      : 'Agency Location';

  String get agencyAddress => isFrench
      ? 'Adresse de l’agence'
      : 'Agency Address';

  String get mapPreview => isFrench
      ? 'Aperçu de la carte'
      : 'Map Preview';
  ...
  String get notAvailable => isFrench
      ? 'Non disponible'
      : 'Not available';
  ...
  String get shareAgency => isFrench
      ? 'Partager l’agence'
      : 'Share Agency';

  String get sharePreview => isFrench
      ? 'Aperçu du partage'
      : 'Share Preview';
  ...
  String get rateReviewAgency => isFrench
      ? 'Noter et donner un avis'
      : 'Rate & Review Agency';

  String get rateThisAgency => isFrench
      ? 'Noter cette agence'
      : 'Rate This Agency';

  String get yourRating => isFrench
      ? 'Votre note'
      : 'Your Rating';
  ...
  String get submitReview => isFrench
      ? 'Envoyer l’avis'
      : 'Submit Review';

  String get selectRatingError => isFrench
      ? 'Veuillez sélectionner une note.'
      : 'Please select a rating.';

  String get enterReviewError => isFrench
  ...
  String get agencyStaff => isFrench
  ...
  String get typeMessage => isFrench
      ? 'Écrire un message...'
      : 'Type a message...';
  ...
  String get completeJourney => isFrench
      ? 'Voyage complet'
      : 'Complete Journey';

  String get pickupTaxi => isFrench
      ? 'Taxi de prise en charge'
      : 'Pickup taxi';

  String get interurbanTransport => isFrench
      ? 'Transport interurbain'
      : 'Interurban transport';

  String get destinationTaxi => isFrench
      ? 'Taxi vers la destination'
      : 'Destination taxi';

  String get interurbanOnly => isFrench
      ? 'Interurbain uniquement'
      : 'Interurban Only';
  ...
  String get busOnly => isFrench
      ? 'Transport interurbain uniquement'
      : 'Bus Only';

  String get departureAgency => isFrench
      ? 'Agence de départ'
      : 'Departure agency';

  String get arrivalAgency => isFrench
      ? 'Agence d’arrivée'
      : 'Arrival agency';
  ...
  String get doorToDoorJourney => isFrench
      ? 'Voyage porte-à-porte'
      : 'Door-to-Door Journey';

  String get interurbanJourney => isFrench
      ? 'Voyage interurbain'
      : 'Interurban Journey';

  String get doorToDoorService => isFrench
      ? 'Service porte-à-porte'
      : 'Door-to-Door Service';

  String get journeyDetails => isFrench
      ? 'Détails du trajet'
      : 'Journey Details';
  ...
  String get pickupLocation => isFrench
  ...
  String get departureCity => isFrench
      ? 'Ville de départ'
      : 'Departure City';

  String get selectDepartureCity => isFrench
  ...
  String get destinationCity => isFrench
  ...
  String get finalDestination => isFrench
      ? 'Destination finale'
      : 'Final Destination';
  ...
  String get travelDate => isFrench
      ? 'Date du voyage'
      : 'Travel Date';

  String get selectTravelDate => isFrench
  ...
  String get luggageDescription => isFrench
      ? 'Nombre de bagages'
  ...
  String get availableTrips => isFrench
      ? 'Voyages disponibles'
      : 'Available Trips';
  ...
  String get interurbanFare => isFrench
      ? 'Tarif interurbain'
      : 'Interurban fare';

  String get perPassenger => isFrench
      ? 'par passager'
      : 'per passenger';

  String get insufficientSeats => isFrench
  ...
  String get reviewBooking => isFrench
      ? 'Vérifier la réservation'
      : 'Review Booking';

  String get agencyToAgencyTransport => isFrench
      ? 'Transport d’agence à agence'
      : 'Agency-to-agency transport';

  String get taxiInterurbanTaxi => isFrench
      ? 'Taxi + Interurbain + Taxi'
      : 'Taxi + Interurban + Taxi';
  ...
  String get selectedTrip => isFrench
      ? 'Voyage sélectionné'
      : 'Selected Trip';
  ...
  String get travelInformation => isFrench
      ? 'Informations de voyage'
      : 'Travel Information';

  String get luggageItems => isFrench
      ? 'Nombre de bagages'
      : 'Luggage Items';

  String get doorToDoorDetails => isFrench
      ? 'Détails du porte-à-porte'
      : 'Door-to-Door Details';

  String get interurbanTrip => isFrench
      ? 'Voyage interurbain'
      : 'Interurban Trip';

  String get priceSummary => isFrench
      ? 'Résumé du prix'
      : 'Price Summary';

  String interurbanFareForPassengers(int count) {
    return isFrench
        ? 'Tarif interurbain × $count'
        : 'Interurban fare × $count';
  }

  String get pickupTaxiFareLabel => isFrench
      ? 'Taxi de prise en charge'
      : 'Pickup taxi';

  String get destinationTaxiFareLabel => isFrench
      ? 'Taxi vers la destination'
      : 'Destination taxi';
  ...
  String get continueToPayment => isFrench
  ...
  String get amountToPay => isFrench
      ? 'Montant à payer'
      : 'Amount to Pay';

  String get selectPaymentMethod => isFrench
  ...
  String get paymentPhoneNumber => isFrench
  ...
  String get processingPayment => isFrench
  ...
  String get paymentSuccessful => isFrench
      ? 'Paiement réussi'
      : 'Payment Successful';
  ...
  String get paymentMethod => isFrench
      ? 'Moyen de paiement'
      : 'Payment Method';

  String get amountPaid => isFrench
      ? 'Montant payé'
      : 'Amount Paid';
  ...
  String get viewDigitalTicket => isFrench
      ? 'Voir le billet numérique'
      : 'View Digital Ticket';

  String get returnToHome => isFrench
      ? 'Retour à l’accueil'
      : 'Return to Home';

  String get bookingConfirmed => isFrench
  ...
  String get digitalTicket => isFrench
      ? 'Billet numérique'
      : 'Digital Ticket';

  String get doorToDoorTicket => isFrench
      ? 'Billet porte-à-porte'
      : 'Door-to-Door Ticket';

  String get interurbanTicket => isFrench
      ? 'Billet interurbain'
      : 'Interurban Ticket';
  ...
  String get passengersLabel => isFrench
      ? 'PASSAGERS'
      : 'PASSENGERS';

  String get luggageLabel => isFrench
      ? 'BAGAGES'
      : 'LUGGAGE';

  String get bookingReference => isFrench
      ? 'Référence de réservation'
      : 'Booking Reference';

  String get ticketReference => isFrench
      ? 'Référence du billet'
      : 'Ticket Reference';
  ...
  String get pickup => isFrench
      ? 'Prise en charge'
      : 'Pickup';

  String get interurban => isFrench
      ? 'Interurbain'
      : 'Interurban';

  String get pickupLocationFallback => isFrench
      ? 'Lieu de prise en charge'
      : 'Pickup location';

  String get finalDestinationFallback => isFrench
      ? 'Destination finale'
      : 'Final destination';
  ...
  String get downloadTicket => isFrench
  ...
  String get trackingServices => isFrench
      ? 'Services de suivi'
      : 'Tracking Services';
  ...
  String get trackYourItems => isFrench
      ? 'Suivez vos articles'
      : 'Track Your Items';
  ...
  String get trackByReference => isFrench
  ...
  String get linkedToBooking => isFrench
      ? 'Lié à la réservation'
      : 'Linked to Booking';

  String get independentParcel => isFrench
      ? 'Colis indépendant'
      : 'Independent Parcel';
  ...
  String get parcelService => isFrench
      ? 'Service de colis'
      : 'Parcel Service';

  String get howTrackingWorks => isFrench
  ...
  String get travelerLuggageDemoReference =>
      'LUG-DEMO-001';

  String get parcelDemoReference =>
      'PAR-DEMO-001';
  ...
  String get trackingDetails => isFrench
      ? 'Détails du suivi'
      : 'Tracking Details';

  String get journeyProgress => isFrench
  ...
  String get transportRoute => isFrench
      ? 'Itinéraire de transport'
      : 'Transport Route';

  String get trackingTimeline => isFrench
      ? 'Chronologie du suivi'
      : 'Tracking Timeline';

  String get currentStatus => isFrench
      ? 'État actuel'
      : 'Current status';
  ...
  String get travelLuggage => isFrench
      ? 'Bagages de voyage'
      : 'Travel Luggage';
  ...
  String get booking => isFrench
      ? 'Réservation'
      : 'Booking';

  String get weight => isFrench
      ? 'Poids'
      : 'Weight';

  String get trackLuggage => isFrench
      ? 'Suivre le bagage'
      : 'Track Luggage';
  ...
  String luggageDescriptionLabel(String description) {
    switch (description) {
      ...
      case 'Medium blue travel bag':
        return isFrench
            ? 'Sac de voyage bleu moyen'
            : 'Medium blue travel bag';
  ...
  String get interurbanParcelService => isFrench
      ? 'Service de colis interurbain'
      : 'Interurban Parcel Service';
  ...
  String get sendNewParcel => isFrench
  ...
  String get sendParcel => isFrench
      ? 'Envoyer un colis'
      : 'Send Parcel';
  ...
  String get recipientInformation => isFrench
      ? 'Informations du destinataire'
      : 'Recipient Information';

  String get recipientName => isFrench
      ? 'Nom du destinataire'
      : 'Recipient Name';

  String get recipientPhone => isFrench
  ...
  String get parcelInformation => isFrench
      ? 'Informations du colis'
      : 'Parcel Information';

  String get parcelDescription => isFrench
  ...
  String get approximateWeight => isFrench
  ...
  String get continueToReview => isFrench
  ...
  String get reviewParcel => isFrench
      ? 'Vérifier le colis'
      : 'Review Parcel';

  String get parcelRoute => isFrench
      ? 'Itinéraire du colis'
      : 'Parcel Route';
  ...
  String get continueToParcelService => isFrench
      ? 'Choisir l’agence et le service'
      : 'Choose Agency & Service';

  // ==================================================
  // PARCEL SERVICE SELECTION
  // ==================================================

  String get parcelServices => isFrench
      ? 'Services de colis'
      : 'Parcel Services';

  String get parcelRequest => isFrench
      ? 'Demande de colis'
      : 'Parcel Request';
  ...
  String get parcelPayment => isFrench
      ? 'Paiement du colis'
      : 'Parcel Payment';
  ...
  String get shipmentConfirmation => isFrench
      ? 'Confirmation de l’expédition'
      : 'Shipment Confirmation';

  String get parcelShipmentCreated => isFrench
      ? 'Expédition du colis créée'
      : 'Parcel Shipment Created';
  ...
  String get trackingReferenceLabel => isFrench
      ? 'RÉFÉRENCE DE SUIVI'
      : 'TRACKING REFERENCE';
  ...
  String get recipient => isFrench
      ? 'Destinataire'
      : 'Recipient';

  String get parcel => isFrench
      ? 'Colis'
      : 'Parcel';

  String get amount => isFrench
      ? 'Montant'
      : 'Amount';

  String get trackParcel => isFrench
      ? 'Suivre le colis'
      : 'Track Parcel';
  ...
  String get myParcelShipments => isFrench
  ...
  String get parcelShipments => isFrench
  ...
  String get bookingMode => isFrench
      ? 'Mode de réservation'
      : 'Booking Mode';
  ...
  String get noUpcomingTrips => isFrench ? 'Aucun voyage à venir' : 'No Upcoming Trips';
  String get noCompletedTrips => isFrench ? 'Aucun voyage terminé' : 'No Completed Trips';
  String get noCancelledTrips => isFrench ? 'Aucun voyage annulé' : 'No Cancelled Trips';
  ...
  String get bookingLuggage => isFrench
      ? 'Bagages de la réservation'
      : 'Booking Luggage';

  String get luggageForThisBooking => isFrench
      ? 'Bagages de cette réservation'
      : 'Luggage for this Booking';

  String get registeredLuggage => isFrench
      ? 'Bagages enregistrés'
      : 'Registered Luggage';
  ...
  String get travelerSuitcase => isFrench
      ? 'Valise du voyageur'
      : 'Traveler suitcase';
  ...
  String get personalInformation => isFrench
  ...
  String get helpSupport => isFrench
      ? 'Aide et assistance'
      : 'Help & Support';
  ...
  String get aboutEasyGo => isFrench
      ? 'À propos de easyGO'
      : 'About easyGO';
  ...
  String get agencyDashboard => isFrench
      ? 'Tableau de bord agence'
      : 'Agency Dashboard';

  String get operations => isFrench
      ? 'Opérations'
      : 'Operations';

  String get messages => isFrench
      ? 'Messages'
      : 'Messages';

  String get bookings => isFrench
      ? 'Réservations'
      : 'Bookings';

  String get parcels => isFrench
      ? 'Colis'
      : 'Parcels';

  String get createTrip => isFrench
      ? 'Créer un voyage'
      : 'Create Trip';

  String get viewTrips => isFrench
      ? 'Voir les voyages'
      : 'View Trips';

  String get viewBookings => isFrench
      ? 'Voir les réservations'
      : 'View Bookings';

  String get manageLuggage => isFrench
      ? 'Gérer les bagages'
      : 'Manage Luggage';

  String get clientMessages => isFrench
      ? 'Messages des clients'
      : 'Client Messages';

  String get tripManagement => isFrench
      ? 'Gestion des voyages'
      : 'Trip Management';

  String get bookingManagement => isFrench
      ? 'Gestion des réservations'
      : 'Booking Management';

  String get luggageManagement => isFrench
      ? 'Gestion des bagages'
      : 'Luggage Management';

  String get parcelManagement => isFrench
      ? 'Gestion des colis'
      : 'Parcel Management';

  String get messageManagement => isFrench
      ? 'Gestion des messages'
      : 'Message Management';

  String get agencyProfile => isFrench
      ? 'Profil de l’agence'
      : 'Agency Profile';

  String get editProfile => isFrench
      ? 'Modifier le profil'
      : 'Edit Profile';

  String get editAgencyProfile => isFrench
      ? 'Modifier le profil de l’agence'
      : 'Edit Agency Profile';
  ...
  String get agencyName => isFrench
      ? 'Nom de l’agence'
      : 'Agency Name';

  String get agencyDescription => isFrench
      ? 'Description de l’agence'
      : 'Agency Description';

  String get generalInformation => isFrench
      ? 'Informations générales'
      : 'General Information';

  String get contactInformation => isFrench
      ? 'Coordonnées'
      : 'Contact Information';

  String get locationInformation => isFrench
      ? 'Informations de localisation'
      : 'Location Information';

  String get emailAddress => isFrench
      ? 'Adresse e-mail'
      : 'Email Address';

  String get phoneNumber => isFrench
      ? 'Numéro de téléphone'
      : 'Phone Number';

  String get headOffice => isFrench
      ? 'Siège principal'
      : 'Head Office';
  ...
  String get profileManagement => isFrench
      ? 'Gestion du profil'
      : 'Profile Management';
  ...
  String get saveChanges => isFrench
      ? 'Enregistrer les modifications'
      : 'Save Changes';

  String get savingChanges => isFrench
      ? 'Enregistrement...'
      : 'Saving Changes...';

  String get requiredField => isFrench
  ...
  String get profileValidated => isFrench
      ? 'Profil validé'
      : 'Profile Validated';
  ...
  String get continueLabel => isFrench
      ? 'Continuer'
      : 'Continue';

  String get confirmed => isFrench
      ? 'Confirmée'
      : 'Confirmed';

  String get completedStatus => isFrench
      ? 'Terminée'
      : 'Completed';

  String get cancelledStatus => isFrench
      ? 'Annulée'
      : 'Cancelled';

  String get scheduledStatus => isFrench
      ? 'Programmé'
      : 'Scheduled';

  String get active => isFrench
      ? 'Actif'
      : 'Active';

  String get deliveredStatus => isFrench
      ? 'Livré'
      : 'Delivered';

  String get clientConversations => isFrench
      ? 'Conversations clients'
      : 'Client Conversations';

  String get noConversationsFound => isFrench
      ? 'Aucune conversation trouvée'
      : 'No conversations found';

  String get replyToClient => isFrench
      ? 'Répondre au client...'
      : 'Reply to client...';

  String get generalInquiry => isFrench
      ? 'Demande générale'
      : 'General Inquiry';

  String get senderInformation => isFrench
      ? 'Informations de l’expéditeur'
      : 'Sender Information';

  String get transportInformation => isFrench
      ? 'Informations de transport'
      : 'Transport Information';

  String get trackingProgress => isFrench
      ? 'Progression du suivi'
      : 'Tracking Progress';

  String get nextValidStatus => isFrench
      ? 'Prochain statut valide'
      : 'Next Valid Status';

  String get updateStatus => isFrench
      ? 'Mettre à jour le statut'
      : 'Update Status';

  String get manageStatus => isFrench
      ? 'Gérer le statut'
      : 'Manage Status';
  ...
  String get recentActivity => isFrench ? 'Activité récente' : 'Recent Activity';
  ...
  String get adminDashboard => isFrench ? 'Tableau de bord administrateur' : 'Admin Dashboard';
  String get platformOverview => isFrench ? 'Vue d’ensemble de la plateforme' : 'Platform Overview';
  String get currentEasyGoActivity => isFrench ? 'Activité actuelle de easyGO' : 'Current easyGO activity';
  ...
  String get manageAgencies => isFrench ? 'Gérer les agences' : 'Manage Agencies';
  ...
  String get manageUsers => isFrench ? 'Gérer les utilisateurs' : 'Manage Users';
  ...
  String get monitorOperations => isFrench ? 'Superviser les opérations' : 'Monitor Operations';
  ...
  String get agencyVerification => isFrench ? 'Vérification des agences' : 'Agency Verification';
  ...
  String get welcomeAdministrator => isFrench ? 'Bienvenue, Administrateur' : 'Welcome, Administrator';
  ...
  String get latestPlatformEvents => isFrench ? 'Derniers événements de la plateforme' : 'Latest platform events';
  String get newAgencyRegistered => isFrench ? 'Nouvelle agence enregistrée' : 'New agency registered';
  String get agencyVerificationCompleted => isFrench ? 'Vérification d’agence terminée' : 'Agency verification completed';
  String get newUserRegistered => isFrench ? 'Nouvel utilisateur enregistré' : 'New user registered';
  ...
  String get agencyManagement => isFrench ? 'Gestion des agences' : 'Agency Management';
  String get searchAgencies => isFrench ? 'Rechercher une agence' : 'Search agencies';
  String get allAdmin => isFrench ? 'Toutes' : 'All';
  String get verifyAgency => isFrench ? 'Vérifier l’agence' : 'Verify Agency';
  String get suspendAgency => isFrench ? 'Suspendre l’agence' : 'Suspend Agency';
  String get reactivateAgency => isFrench ? 'Réactiver l’agence' : 'Reactivate Agency';
  String get verificationStatus => isFrench ? 'Statut de vérification' : 'Verification Status';
  ...
  String get totalBookings => isFrench ? 'Total des réservations' : 'Total Bookings';
  String get userManagement => isFrench ? 'Gestion des utilisateurs' : 'User Management';
  String get searchUsers => isFrench ? 'Rechercher un utilisateur' : 'Search users';
  String get userDetails => isFrench ? 'Détails de l’utilisateur' : 'User Details';
  String get accountStatus => isFrench ? 'Statut du compte' : 'Account Status';
  String get registeredDate => isFrench ? 'Date d’inscription' : 'Registration Date';
  String get completedTrips => isFrench ? 'Voyages terminés' : 'Completed Trips';
  String get suspendUser => isFrench ? 'Suspendre l’utilisateur' : 'Suspend User';
  String get activateUser => isFrench ? 'Activer l’utilisateur' : 'Activate User';
  String get operationsMonitoring => isFrench ? 'Supervision des opérations' : 'Operations Monitoring';
  ...
  String get monitorTrips => isFrench ? 'Superviser les voyages' : 'Monitor Trips';
  String get monitorBookings => isFrench ? 'Superviser les réservations' : 'Monitor Bookings';
  String get monitorLuggage => isFrench ? 'Superviser les bagages' : 'Monitor Luggage';
  String get monitorParcels => isFrench ? 'Superviser les colis' : 'Monitor Parcels';
  String get platformTrips => isFrench ? 'Voyages de la plateforme' : 'Platform Trips';
  String get platformBookings => isFrench ? 'Réservations de la plateforme' : 'Platform Bookings';
  String get platformLuggage => isFrench ? 'Bagages de la plateforme' : 'Platform Luggage';
  String get platformParcels => isFrench ? 'Colis de la plateforme' : 'Platform Parcels';
  ...
  String get adminNotifications => isFrench ? 'Notifications administrateur' : 'Admin Notifications';
  String get markAllAsRead => isFrench ? 'Tout marquer comme lu' : 'Mark All as Read';
  String get adminProfile => isFrench ? 'Profil administrateur' : 'Admin Profile';
  String get administrator => isFrench ? 'Administrateur' : 'Administrator';
  String get platformAdministration => isFrench ? 'Administration de la plateforme' : 'Platform Administration';
